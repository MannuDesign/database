...
if (isset($_POST['submit'])) {
    ...
    // Unique icon name
    $new_icon_name = time() . '_' . basename($icon);
    $target_file = $upload_dir . $new_icon_name;

    if (move_uploaded_file($tmp_name, $target_file)) {
        $sql = "INSERT INTO service (icon, heading, description) 
                VALUES ('$new_icon_name', '$heading', '$description')";

        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Service Added Successfully'); window.location.href='view-service.php';</script>";
        } else {
            echo "Database Error: " . $conn->error;
        }
    } else {
        echo "<script>alert('Icon upload failed');</script>";
    }
}
?>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input type="text" name="heading" class="form-control"
                                                                    placeholder="Add heading *" required />
                                                            </div>
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <textarea name="description" class="form-control"
                                                                    rows="4" placeholder="Enter service description..."
                                                                    required></textarea>
                                                            </div>
