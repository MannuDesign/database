                                    ...
                                    <table id="example"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-ordering="false">AddteanName</th>
                                                <th data-ordering="false">addDescription</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 0;
                                            $sql = "SELECT * FROM addteam  ORDER BY id DESC";
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $row['addteanName']; ?></td>
                                                        <td><?php echo $row['addDescription']; ?></td>
                                                        <td>
                                                            <img src="./uploads/<?php echo ($row['addteamimages']); ?>"
                                                                style="width: 50px;">
                                                        </td>
                                                        <td>
                                                            <a href="editteam.php?id=<?php echo $row['id']; ?>">
                                                                <button type="button"
                                                                    class="btn btn-danger btn-icon waves-effect waves-light"><i
                                                                        class="ri-pencil-fill"></i></button>
                                                            </a>

                                                            <a href="delete_team.php?id=<?php echo $row['id']; ?>">
                                                                <button type="button"
                                                                    class="btn btn-danger btn-icon waves-effect waves-light"><i
