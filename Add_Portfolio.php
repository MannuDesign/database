...
if (isset($_POST['submit'])) {
    ...
    $image = $_FILES['Port_image']['name'];
    $tmp_name = $_FILES['Port_image']['tmp_name'];
    $upload_dir = "uploads/portfolioimages/";
    ...
    if (in_array($file_ext, $allowed_extensions)) {
        ...
        if (move_uploaded_file($tmp_name, $target_file)) {
            ...
            $sql = "INSERT INTO portfolio (image, heading, sub_heading) 
                    VALUES ('$new_image_name', '$heading', '$sub_heading')";

            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Portfolio Item Added Successfully'); window.location.href='view_Portfolio.php'; </script>";
            } else {
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <textarea name="sub_heading" class="form-control"
