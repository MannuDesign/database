                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $i; ?></td>
                                                            <td>
                                                                <img src="uploads/portfolioimages/<?php echo htmlspecialchars( $row['image']); ?>"
                                                                    style="width: 50px;">
                                                            </td>
                                                            <td><?php echo htmlspecialchars($row['heading']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['sub_heading']); ?></td>
                                                            <td>
                                                                <a href="editPortfolio.php?id=<?php echo $row['id']; ?>"
                                                                    class="btn btn-sm btn-warning">Edit</a>
                                                                <a href="deleteportfolio.php?id=<?php echo $row['id']; ?>"
