...
if (isset($_POST['submit'])) {
    ...
    $headingfeq = $_POST['headingfeq']; // Correct variable name
    $descriptionfeq = $_POST['descriptionfeq']; // Correct variable name

    $sql = "INSERT INTO faq (headingfeq, descriptionfeq) VALUES ('$headingfeq', '$descriptionfeq')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('FAQ Added Successfully'); window.location.href='view-faq.php'</script>";
    } else {
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input type="text" name="headingfeq"
                                                                    class="form-control"
                                                                    placeholder="Enter FAQ  heading" required />
                                                            </div>
