...
if (isset($_POST['update'])) {
    ...
    if (!empty($image)) {
        ...
        move_uploaded_file($tmp, "uploads/portfolioimages/" . $image);
    } else {
        $image = $old_image;
    }

    $sql = "UPDATE portfolio SET heading='$heading', sub_heading='$sub_heading', image='$image' WHERE id=$id";
...
<body>
    ...
    <div class="card p-4 shadow">
        ...
        <div class="mt-3">
            ...
            <img src="uploads/portfolioimages//<?php echo $row['image']; ?>" width="100" alt="Image"><br><br>
        ...
        <div class="mt-3">
            ...
            <input type="text" name="heading" class="form-control"
                   value="<?php echo htmlspecialchars($row['heading']); ?>" required>
        </div>

        <div class="mt-3">
            <label class="form-label">Sub Heading</label>
            <textarea name="sub_heading" class="form-control" rows="4"
                      required><?php echo htmlspecialchars($row['sub_heading']); ?></textarea>
        </div>
