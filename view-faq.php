                                    ...
                                    <table id="example"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-ordering="false">headingfeq</th>
                                                <th data-ordering="false">descriptionfeq </th>
                                                <th data-ordering="false"> Actuion </th>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo htmlspecialchars($row['headingfeq']); ?></td>
                                                        <td><?php echo htmlspecialchars($row['descriptionfeq']); ?></td>
                                                        <td>
                                                            <a href="editfaq.php?id=<?php echo $row['id']; ?>">
                                                                <button type="button"
                                                            ...
                                                            <a href="deletefaq.php?id=<?php echo $row['id']; ?>"
                                                ...
                                                echo "<tr><td colspan='5'>No FAQ records found</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
