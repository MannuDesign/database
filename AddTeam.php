...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($tmp_name, $target_file)) {
        // Save to DB
        $sql = "INSERT INTO addteam (addteanName, addDescription, addteamimages) 
                VALUES ('$name', '$addDescription', '$new_image_name')";

        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Team Added Successfully'); window.location.href='view_team.php';</script>";
        } else {
            echo "<script>alert('Database Error: " . $conn->error . "'); window.location.href='AddTeam.php';</script>";
        }
    } else {
        echo "<script>alert('Image upload failed'); window.location.href='AddTeam.php';</script>";
    }
}
?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div
                                ...
                                <h4 class="mb-sm-0"> Manage Team </h4>
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div>
                                                                <label class="form-label">Add Team Name</label>
                                                                <input type="text" name="addteanName"
                                                                    class="form-control" placeholder="Add Team Name*"
                                                                    required />
                                                            </div>

                                                            <div class="mt-3">
                                                                <label class="form-label">Add Team Description</label>
                                                                <textarea name="addDescription" class="form-control"
                                                                    rows="4" placeholder="Add Description..."
                                                                    required></textarea>
                                                            </div>

                                                            <div class="mt-3">
                                                                <label class="form-label">Upload Team Image</label>
