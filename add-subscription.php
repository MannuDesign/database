...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO subscription (name,status) VALUES ('$name','$status')";

    if ($conn->query($sql) === TRUE) {

        echo "<script>alert('Subscription Added Successfully'); window.location.href='#';</script>";
    } else {
                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <div>
                                                    <label class="form-label"> Subscription Category Name </label>
                                                ...
                                                <div class="col-md-3 position-relative">
                                                    <label for="validationTooltip04" class="form-label">Show on Menu?
                                                        *</label>
                                                    <select class="form-select" name="status" id="validationTooltip04"
                                                        required>
