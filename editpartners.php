...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE partners SET p_imges='$image', p_name='$name' WHERE id=$id";
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Partners Edit Successfully'); window.location.href='view-partners.php'; </script>";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div
                                ...
                                <h4 class="mb-sm-0"> Partner
                                </h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Partners
                                            </a></li>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="old_image"
                                                    value="<?php echo $row['p_imges']; ?>">

                                                <label>Current Image</label><br>
                                                <img src="uploads/partner/<?php echo $row['p_imges']; ?>" width="100"><br><br>

                                                <label>Change Image</label>
                                                <input type="file" name="p_imges" class="form-control"><br>

                                                <label>Partner Name</label>
                                                <input type="text" name="p_name" class="form-control"
                                                    value="<?php echo $row['p_name']; ?>"><br>
