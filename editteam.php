...
if (isset($_POST['update'])) {
    ...
    // Update the database
    $stmt = $conn->prepare("UPDATE portfolio SET heading = ?, sub_heading = ?, image = ? WHERE id = ?");
    $stmt->bind_param("sssi", $heading, $sub_heading, $image, $id);

    if ($stmt->execute()) {
        echo "<script>alert('Portfolio updated successfully.'); window.location.href='view_Portfolio.php';</script>";
    } else {
