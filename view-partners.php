...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['p_imges']['name']) {
        $image = $_FILES['p_imges']['name'];
        $tmp = $_FILES['p_imges']['tmp_name'];
        move_uploaded_file($tmp, "uploads/partner/" . $image);
    } else {
        $image = $_POST['old_image'];
    }

    $update = "UPDATE partners SET p_imges='$image', p_name='$name' WHERE id=$id";
    if (mysqli_query($conn, $update)) {
        echo "Updated Successfully!";
        header("Location: partners.php"); // redirect to list
    } else {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div
                                ...
                                <h4 class="mb-sm-0">view Partner </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">View Partner</h5>
                                </div>
                                <?php
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $i; ?></td>
                                                            <td>
                                                                <img src="uploads/partner/<?php echo htmlspecialchars($row['p_imges']); ?>"
                                                                    style="width: 50px;">
                                                            </td>
                                                            <td><?php echo htmlspecialchars($row['p_name']); ?></td>
                                                            <td>

                                                                <a href="editpartners.php?id=<?php echo $row['id']; ?>">
                                                                    <button class="btn btn-success btn-icon"><i
                                                                            class="ri-pencil-fill"></i></button>
                                                                </a>

                                                                <a href="deletepartner.php?id=<?php echo $row['id']; ?>"
                                                    ...
                                                    echo "<tr><td colspan='6'>No service records found</td></tr>";
                                                }
                                            } else {
