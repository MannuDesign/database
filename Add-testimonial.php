...
if (isset($_POST['submit'])) {
    ...
    // Insert only heading and position — no image handling
    $stmt = $conn->prepare("INSERT INTO testimonial (heading, position) VALUES (?, ?)");
    $stmt->bind_param("ss", $heading, $position);

    if ($stmt->execute()) {
        echo "<script>alert('Testimonial Added Successfully'); window.location.href='view-testimonial.php';</script>";
    } else {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div
                                ...
                                <h4 class="mb-sm-0"> Testimonial.php </h4>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <textarea name="position" class="form-control" rows="4"
                                                                    placeholder="Enter position" required></textarea>
                                                            </div>
