...
// Fetch existing testimonial details using the ID
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
// Update the testimonial on form submission
if (isset($_POST['update'])) {
    $heading = $_POST['heading'];
    $position = $_POST['position'];
    $id = $_POST['id']; // Using POST here instead of GET

    $sql = "UPDATE testimonial SET heading = '$heading', position = '$position' WHERE id = '$id'";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Testimonial updated successfully'); window.location.href='view-testimonial.php';</script>";
    } else {
                ...
                <div class="col-lg-12">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="heading" class="form-control" placeholder="Enter heading"
                            value="<?php echo isset($row['heading']) ? htmlspecialchars($row['heading']) : ''; ?>" required />
                    </div>

                    <!-- Position -->
                    <div class="mt-3">
                        <label class="form-label">Position</label>
                        <textarea name="position" class="form-control" rows="4" placeholder="Enter description..." required><?php echo isset($row['position']) ? htmlspecialchars($row['position']) : ''; ?></textarea>
                    </div>
