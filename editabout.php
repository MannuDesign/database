    ...
    if (in_array($fileType, $allowedTypes)) {
        ...
        if ($check !== false) {
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
                ...
                // Save to database
                $sql = "REPLACE INTO about (id, images, heading, description) VALUES (3, ?, ?, ?)";
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-3">
                                            ...
                                            <input type="text" name="heading"
                                                class="form-control rounded-end flag-input" placeholder="Heading *"
                                                required />
                                        </div>
                                        <div class="mt-3">
                                            <label class="form-label">Description</label>
                                            <textarea name="description" class="form-control rounded-end flag-input"
                                                placeholder="Description" required></textarea>
                                        </div>
                                        <div class="mt-3">
                                            <label class="form-label">Image *</label>
                                            <input type="file" name="image" class="form-control rounded-end flag-input"
