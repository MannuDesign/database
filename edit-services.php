...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['icon']['name'])) {
        ...
        $iconName = $data['icon']; // keep existing icon
    }
    ...
    if ($conn->query($update)) {
        echo "<script>alert('Updated successfully');window.location.href='view-service.php';</script>";
    } else {
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <img src="uploads/services/<?php echo $data['icon']; ?>"
                                                                    style="width: 60px;">
                                                            </div>
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input type="text" name="heading" class="form-control"
                                                                    value="<?php echo htmlspecialchars($data['heading']); ?>"
                                                                    required />
                                                            </div>
