...
if (isset($_POST['submit'])) {
    ...
    $tmp_name = $_FILES['p_imges']['tmp_name'];
    ...
    if (move_uploaded_file($tmp_name, $target_file)) {
        ...
        $sql = "INSERT INTO partners (p_imges, p_name) 
                VALUES ('$new_image_name', '$p_name')";

        if ($conn->query($sql) === TRUE) {

            echo "<script>alert(' Partners Added Successfully'); window.location.href='view-partners.php'; </script>";
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input type="file" name="p_imges" class="form-control"
                                                                    required />
                                                            </div>
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <textarea name="p_name" class="form-control" rows="4"
