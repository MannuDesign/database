...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>alert('Category Added Successfully'); window.location.href='view-category.php';</script>";
    } else {

        echo "<script>alert('Error: " . $conn->error . "'); window.location.href='add-category.php';</script>";
    }
